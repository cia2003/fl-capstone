...
export function ChatInput({ films }: { films: Film[] }) {
  ...
  return (
    ...
    <ChatMessages messages={chat.messages}  films={films} bottomRef={chat.bottomRef} loading={chat.loading} isThinking={chat.isThinking}  error={chat.error} newChat={chat.newChat} addToolOutput={chat.addToolOutput} />
